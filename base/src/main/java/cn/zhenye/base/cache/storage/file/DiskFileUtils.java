package cn.zhenye.base.cache.storage.file;
...
/**
 * @author WilliamChik on 2018/1/31.
 */
public class DiskFileUtils {
    ...
    public static CacheDirInfo getDiskCacheDir(Context context, String uniqueName, long requireSpace) {
        ...
        if (!cacheDirInfo.path.exists() && !cacheDirInfo.path.mkdirs()) {
            Log.e(DiskFileUtils.class.getSimpleName(),"can not create directory for: " + cacheDirInfo.path);
        }
        return cacheDirInfo;
    }
